...
function render(){document.documentElement.lang=lang;document.querySelectorAll('[data-i18n]').forEach(e=>e.textContent=t(e.dataset.i18n));document.querySelectorAll('[data-lang-label]').forEach(e=>e.textContent=t('lang')+' ▾');document.querySelectorAll('[data-beta]').forEach(e=>e.href=betaUrl);document.querySelectorAll('[data-support-email]').forEach(e=>e.href=`mailto:${supportEmail}?subject=Beyond%20Commander%20support`);document.querySelectorAll('[data-mock]').forEach(e=>{let v=e.dataset.mock;e.innerHTML=v==='deck'?`<div class="hero-shot-wrap"><div class="hero-shot" role="img" aria-label="Beyond Commander themed preview"></div><div class="hero-shot-overlay">${t('soon')}</div></div>`:`<div class="bc-card ${v||'light'}">${mock()}</div>`})}
